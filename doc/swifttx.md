...
This mechanism has been integrated into Bitcore-Node-SMRT which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SMRT-Project/insight-api-smrt#web-socket-api](https://github.com/SMRT-Project/insight-api-smrt#web-socket-api) 
* API: [https://github.com/SMRT-Project/insight-api-smrt#swifttx-transactions](https://github.com/SMRT-Project/insight-api-smrt#swifttx-transactions) 
...
By default, the SMRT Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SMRT Core daemon:
