                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SMRT Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SMRT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and smrt: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSMRT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SMRT Core"), this);
    aboutAction->setStatusTip(tr("Show information about SMRT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SMRT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SMRT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SMRT addresses"));
    ...
    openAction->setStatusTip(tr("Open a SMRT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SMRT Core help message to get a list with possible SMRT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SMRT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SMRT network", "", count));
}
...
{
    QString strTitle = tr("SMRT Core"); // default title
