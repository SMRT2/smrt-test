...
#ifndef SMRT_STAKEINPUT_H
#define SMRT_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZSMRT() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zSMRTStake can take two forms
...
public:
    ...
    bool IsZSMRT() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZSMRT() override { return false; }
};


#endif //SMRT_STAKEINPUT_H
