...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SMRT features */
        {"smrt", "masternode", &masternode, true, true, false},
        {"smrt", "listmasternodes", &listmasternodes, true, true, false},
        {"smrt", "getmasternodecount", &getmasternodecount, true, true, false},
        {"smrt", "masternodeconnect", &masternodeconnect, true, true, false},
        {"smrt", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"smrt", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"smrt", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"smrt", "masternodecurrent", &masternodecurrent, true, true, false},
        {"smrt", "masternodedebug", &masternodedebug, true, true, false},
        {"smrt", "startmasternode", &startmasternode, true, true, false},
        {"smrt", "createmasternodekey", &createmasternodekey, true, true, false},
        {"smrt", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"smrt", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"smrt", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"smrt", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"smrt", "getmasternodescores", &getmasternodescores, true, true, false},
        {"smrt", "mnbudget", &mnbudget, true, true, false},
        {"smrt", "preparebudget", &preparebudget, true, true, false},
        {"smrt", "submitbudget", &submitbudget, true, true, false},
        {"smrt", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"smrt", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"smrt", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"smrt", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"smrt", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"smrt", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"smrt", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"smrt", "checkbudgets", &checkbudgets, true, true, false},
        {"smrt", "mnsync", &mnsync, true, true, false},
        {"smrt", "spork", &spork, true, true, false},
        {"smrt", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> smrt-cli " + methodname + " " + args + "\n";
}
